				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon">
						<div class="card-body">
							...
							%>
							<h3 class="text-center default-text text-primary">Add Vehicle</h3>
							<%
								}
							%>
							<!--Body-->
							<div>
								...
								<%
									HashMap map = (HashMap) request.getAttribute("numberr");
								%>
							...
							<div class="md-form">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<input type="text" name="colour" placeholder="Enter colour"
											class="form-control"
											oninput="handleLetterInput(this, 'colourError', 25)"
											onblur="validateLetterInput(this, 'colourError', 25)"
								...
								<font color="red" class="pl-sm-5" id="colourError"> <%=ServletUtility.getErrorMessage("colour", request)%></font></br>
					...
					: DataUtility.getStringData(dto.getInsuranceAmount())%>">
								...
								<div class="col-sm-12">
									<div class="input-group">
										...
										<%=HTMLUtility.getList("number", String.valueOf(dto.getNumber()), map)%>
