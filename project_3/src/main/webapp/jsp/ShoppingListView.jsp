...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.SHOPPING_LIST_CTL%>" method="post">
 ...
 --%>
			...
			%>
			<center>
				<h1 style="font-size: 40px; color: #162390;">ShoppingCard List</h1>
			</center>
			</br>
			<div class="row">
				<div class="col-md-4"></div>
