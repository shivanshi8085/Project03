...
<body class="hm">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<%-- <input type="text" class="form-control" name="customer_id"
						...
						oninput="handleIntegerInput(this, 'customer_idError', 10)"
						onblur="validateIntegerInput(this, 'customer_idError', 10)"
						value="<%=ServletUtility.getParameter("customer_id", request)%>">
					<font color="red" class="pl-sm-5" id="customer_idError"></font>
 ...
 --%>
					...
					<div class="col-sm-2"><%=HTMLUtility.getList("customer_id", String.valueOf(dto.getCustomer_id()), map)%></div>
					...
					<table class="table table-bordered table-dark table-hover">
						<thead>
							<tr style="background-color: purple;">
								...
								<th width="20%" class="text">Loan_amount</th>
						...
						<tbody>
							<tr>
								...
								<td class="text"><%=dto.getCustomer_id()%></td>
